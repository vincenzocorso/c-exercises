...
int crescente(const unsigned int dimensione, const float vettore[]);
...
int main()
{
	...
	printf("Il vettore1 è crescente? %d\n", crescente(5, vettore1));
	printf("Il vettore2 è crescente? %d\n", crescente(5, vettore2));
	printf("Il vettore3 è crescente? %d\n", crescente(5, vettore3));
	printf("Il vettore4 è crescente? %d\n", crescente(5, vettore4));
